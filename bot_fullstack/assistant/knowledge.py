...
registration_events.json и dialogues.json. Файл tests.json читают прогонщик
проверок и загрузчик карточек (database/case_seed.py) — и только реплики
человека: ожидаемые ответы в базу знаний агента не загружаются.
"""
import json
import os
import pathlib
